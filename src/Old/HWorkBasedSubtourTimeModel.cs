...
namespace Daysim.ChoiceModels {
	public static class HWorkBasedSubtourTimeModel {
		private const string CHOICE_MODEL_NAME = "HWorkBasedSubtourTimeModel";
		...
		private static void Initialize() {
			...
			ChoiceModelHelper.Initialize(ref _helpers[ParallelUtility.GetBatchFromThreadId()], CHOICE_MODEL_NAME, Global.Configuration.WorkBasedSubtourTimeModelCoefficients, TourTime.TOTAL_TOUR_TIMES, TOTAL_NESTED_ALTERNATIVES, TOTAL_LEVELS, MAX_PARAMETER);
		}
		...
		public static void Run(TourWrapper subtour) {
			...
			if (_helpers[ParallelUtility.GetBatchFromThreadId()].ModelIsInEstimationMode) {
				if (subtour.DestinationParcel == null || subtour.OriginParcel == null || subtour.Mode <= Constants.Mode.NONE || subtour.Mode >= Constants.Mode.PARK_AND_RIDE) {
					return;
				}
