...
namespace Daysim.ChoiceModels {
	public static class HSchoolTourTimeModel {
		private const string CHOICE_MODEL_NAME = "HSchoolTourTimeModel";
		...
		private static void Initialize() {
			...
			ChoiceModelHelper.Initialize(ref _helpers[ParallelUtility.GetBatchFromThreadId()], CHOICE_MODEL_NAME, Global.Configuration.SchoolTourTimeModelCoefficients, TourTime.TOTAL_TOUR_TIMES, TOTAL_NESTED_ALTERNATIVES, TOTAL_LEVELS, MAX_PARAMETER);
		}
