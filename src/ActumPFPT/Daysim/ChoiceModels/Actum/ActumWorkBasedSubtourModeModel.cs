...
namespace Daysim.ChoiceModels {
	public class ActumWorkBasedSubtourModeModel : ChoiceModel {
		...
		public ChoiceProbabilityCalculator.Alternative RunNested(TourWrapper subtour, CondensedParcel destinationParcel) {
			if (subtour == null) {
				throw new ArgumentNullException("subtour");
			}
