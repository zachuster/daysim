...
namespace Daysim.ChoiceModels.Actum {
	public class ActumJointTourParticipationModel : ChoiceModel {
		...
		public int[] Run(ActumHouseholdDayWrapper householdDay, int nCallsForTour, int[] purpose, bool[,] jTParticipation) {
		...
		private void RunModel(ChoiceProbabilityCalculator choiceProbabilityCalculator, ActumHouseholdDayWrapper householdDay, int nCallsForTour, int[] purpose, int[][] altParticipants, int choice = Constants.DEFAULT_VALUE) {
