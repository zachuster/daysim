...
namespace Daysim.ChoiceModels {
	public static class HEscortTourModeModel {
		private const string CHOICE_MODEL_NAME = "HEscortTourModeModel";
		...
		private static void Initialize() {
			lock (_lock) {
				...
				ChoiceModelHelper.Initialize(ref _helpers[ParallelUtility.GetBatchFromThreadId()], CHOICE_MODEL_NAME, Global.GetInputPath(Global.Configuration.EscortTourModeModelCoefficients),
