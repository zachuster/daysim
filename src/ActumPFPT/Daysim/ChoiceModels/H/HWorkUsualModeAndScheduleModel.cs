...
namespace Daysim.ChoiceModels {
	public static class HWorkUsualModeAndScheduleModel {
		...
		private static void RunModel(ChoiceProbabilityCalculator choiceProbabilityCalculator, IPersonWrapper person) {
			...
			var destinationParkingCost = (Global.Configuration.ShouldRunPayToParkAtWorkplaceModel && person.PayToParkAtWorkplaceFlag == 0) ? 0.0 : destinationParcel.ParkingCostBuffer1(parkingDuration);
