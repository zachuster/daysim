...
namespace Daysim.ChoiceModels {
	public static class HTripModeModel {
		...
		private static void Initialize() {
			...
			ChoiceModelHelper.Initialize(ref _helpers[ParallelUtility.GetBatchFromThreadId()], CHOICE_MODEL_NAME, Global.GetInputPath(Global.Configuration.TripModeModelCoefficients), Constants.Mode.TOTAL_MODES, TOTAL_NESTED_ALTERNATIVES, TOTAL_LEVELS, MAX_PARAMETER);
		}
		...
		private static void RunModel(ChoiceProbabilityCalculator choiceProbabilityCalculator, ITripWrapper trip, List<PathTypeModel> pathTypeModels, ICondensedParcel originParcel, ICondensedParcel destinationParcel,
