...
namespace Daysim.Tests
{
	public class CondensedParcelTest 
	{
		...
		public void TestCondensedParcel()
		{
			...
			int xCoordinate = 4;
			int yCoordinate = 5;
			int transimsActivityLocation = 6;
			int landUseCode19 = 7;
			double households = 8;
			double studentsK8 = 9;
			double studentsHighSchool = 10;
			double studentsK12 = 11;
			double studentsUniversity = 12;
			double employmentEducation = 13;
			double employmentFood = 14;
			double employmentGovernment = 15;
			double employmentIndustrial = 16;
			double employmentMedical = 17;
			double employmentOffice = 18;
			double employmentRetail = 19;
			double employmentService = 20;
			double employmentAgricultureConstruction = 21;
			double employmentTotal = 22;
			double parkingOffStreetPaidDailySpaces = 23;
			double studentsK8Buffer1 = 24;
			double studentsHighSchoolBuffer1 = 25;
			double studentsK8Buffer2 = 26;
			double studentsHighSchoolBuffer2 = 27;
			double employmentFoodBuffer1 = 28;
			double employmentMedicalBuffer1 = 29;
			double employmentMedicalBuffer2 = 30;
			double employmentRetailBuffer1 = 31;
			double employmentServiceBuffer1 = 32;
			double parkingOffStreetPaidDailyPriceBuffer1 = 33;
			double parkingOffStreetPaidHourlyPriceBuffer1 = 34;
			double parkingOffStreetPaidDailyPriceBuffer2 = 35;
			double parkingOffStreetPaidHourlyPriceBuffer2 = 36;
			double stopsTransitBuffer1 = 37;
			double stopsTransitBuffer2 = 38;
			double nodesSingleLinkBuffer1 = 39;
			double nodesThreeLinksBuffer1 = 40;
			double nodesFourLinksBuffer1 = 41;
			double openSpaceType1Buffer1 = 42;
			double openSpaceType2Buffer1 = 43;
			double openSpaceType1Buffer2 = 44;
			double openSpaceType2Buffer2 = 45;
			double employmentFoodBuffer2 = 46;
			double employmentRetailBuffer2 = 47;
			double employmentServiceBuffer2 = 48;
			double householdsBuffer2 = 49;
			double nodesSingleLinkBuffer2 = 50;
			double nodesThreeLinksBuffer2 = 51;
			double nodesFourLinksBuffer2 = 52;
			double distanceToLocalBus = 53;
			double distanceToLightRail = 54;
			double distanceToExpressBus = 55;
			double distanceToCommuterRail = 56;
			double distanceToFerry = 57;
			double distanceToTransit = 58;
			double shadowPriceForEmployment = 59;
			double shadowPriceForStudentsK12 = 60;
			double shadowPriceForStudentsUniversity = 61;
			double externalEmploymentTotal = 62;
			double employmentDifference = 63;
			double employmentPrediction = 64;
			double externalStudentsK12 = 65;
			double studentsK12Difference = 66;
			double studentsK12Prediction = 67;
			double externalStudentsUniversity = 68;
			double studentsUniversityDifference = 69;
			double studentsUniversityPrediction = 70;
			double parkingOffStreetPaidHourlySpaces = 71;
			double employmentGovernmentBuffer1 = 72;
			double employmentOfficeBuffer1 = 73;
			double employmentGovernmentBuffer2 = 74;
			double employmentOfficeBuffer2 = 75;
			double employmentEducationBuffer1 = 76;
			double employmentEducationBuffer2 = 77;
			double employmentAgricultureConstructionBuffer1 = 78;
			double employmentIndustrialBuffer1 = 79;
			double employmentAgricultureConstructionBuffer2 = 80;
			double employmentIndustrialBuffer2 = 81;
			double employmentTotalBuffer1 = 82;
			double employmentTotalBuffer2 = 83;
			double householdsBuffer1 = 84;
			double studentsUniversityBuffer1 = 85;
			double studentsUniversityBuffer2 = 86;
			double parkingOffStreetPaidHourlySpacesBuffer1 = 87;
			double parkingOffStreetPaidDailySpacesBuffer1 = 88;
			double parkingOffStreetPaidHourlySpacesBuffer2 = 89;
			double parkingOffStreetPaidDailySpacesBuffer2 = 90;
			double circuityRatio_E1 = 91;
			double circuityRatio_E2 = 92;
			double circuityRatio_E3 = 93;
			double circuityRatio_NE1 = 94;
			double circuityRatio_NE2 = 95;
			double circuityRatio_NE3 = 96;
			double circuityRatio_N1 = 97;
			double circuityRatio_N2 = 98;
			double circuityRatio_N3 = 99;
			double circuityRatio_NW1 = 100;
			double circuityRatio_NW2 = 101;
			double circuityRatio_NW3 = 102;
			double circuityRatio_W1 = 103;
			double circuityRatio_W2 = 104;
			double circuityRatio_W3 = 105;
			double circuityRatio_SW1 = 106;
			double circuityRatio_SW2 = 107;
			double circuityRatio_SW3 = 108;
			double circuityRatio_S1 = 109;
			double circuityRatio_S2 = 110;
			double circuityRatio_S3 = 111;
			double circuityRatio_SE1 = 112;
			double circuityRatio_SE2 = 113;
			double circuityRatio_SE3 = 114;
		...
		public void TestCondensedParcelExtensions()
		{
			...
			double millionsSquareLengthUnits = 2.01;
			...
			households = parcel.HouseholdsBuffer2 * 100;
			total = total = (parcel.EmploymentRetailBuffer2 + parcel.EmploymentServiceBuffer2 + parcel.EmploymentFoodBuffer2) * 100;
		...
		public void TestCircuityDistance1()
		{
			...
			ICondensedParcelExtensions.InitializeIndex(reader);
		...
		public void TestCircuityDistance2()
		{
			...
			Global.Configuration.MaximumBlendingDistance = 10;
			double dWeight2 = (3700 - 2640.0) / (5280.0 - 2640.0);
			double dWeight1 = 1.0 - dWeight2;
			var odAngle = 12.0 / 35.0;
		...
		public void TestCircuityDistance3()
		{
			...
			Global.Configuration.MaximumBlendingDistance = 10;
			double dWeight3 = (5300.0 - 5280.0) / (7920.0 - 5280.0);
			double dWeight2 = 1.0 - dWeight3;
			var odAngle = 28.0 / 45.0;
		...
		public void TestNodeToNode1()
		{
			...
			Assert.Equal(ans, parcel.NodeToNodeDistance(destination));
		...
		public void TestParcel()
		{
			...
			int landUseCode = 115;
			double parkingOffStreetPaidDailyPrice = 116;
			double parkingOffStreetPaidHourlyPrice = 117;
			double thousandsSquareLengthUnits = 118;
			double zoneKey = 119;
