...
namespace Daysim.Tests 
{
	...
	public class HouseholdTest 
	{
		...
		{
			int fulltimeWorkers = 1;
			int partTimeWorkers = 2;
			int retiredAdults = 3;
			int nonworkingAdults = 4;
			int universityStudents = 5;
			int drivingAgeStudents = 6;
			int childrenAge5Through15 = 7;
			int childrenUnder5 = 8;
			int childrenUnder16 = 9;
			int adults = 10;
			int drivingAgeMembers = 11;
			int workersPlusStudents = 12;
			int fullAndPartTimeWorkers = 13;
			int allWorkers = 14;
			int allStudents = 15;
			double partTimeWorkersPerDrivingAgeMembers = 16.1;
			double retiredAdultsPerDrivingAgeMembers = 17.1;
			double universityStudentsPerDrivingAgeMembers = 18.1;
			double drivingAgeStudentsPerDrivingAgeMembers = 19.1;
			double homeBasedPersonsPerDrivingAgeMembers = 21.1;
		...
		public void TestHousehold()
		{
			...
			int size = 16;
			int vehiclesAvailable = 13;
			int workers = 19;
			int fulltimeWorkers = 17;
			int partTimeWorkers = 2;
			int retiredAdults = 3;
			int otherAdults = 1;
			int collegeStudents = 4;
			int highSchoolStudents = 5;
			int kidsBetween5And15 = 6;
			int kidsBetween0And4 = 7;
			int income = 16000;
			int ownOrRent = 1;
			int residenceType = 2;
			int residenceParcelId = 3;
