...
namespace Daysim.Tests 
{
	...
	public class FullHalfTourTest 
	{
		...
		public void TestFullHalfTourWrapper()
		{
			...
			FullHalfTourWrapper wrapper = new FullHalfTourWrapper(tour, householdDayWrapper, new PersisterWithHDF5<FullHalfTour>(new TestFullHalfTourExporter()));
		...
		public void TestFullHalfTourExport()
		{
			...
			FullHalfTourWrapper wrapper = new FullHalfTourWrapper(tour, householdDayWrapper, new PersisterWithHDF5<FullHalfTour>(exporter));
