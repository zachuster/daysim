...
namespace Daysim.Tests 
{
	...
	public class PartialHalfTourTest 
	{
		...
		public void TestPartialHalfTourWrapper()
		{
			...
			PartialHalfTourWrapper wrapper = new PartialHalfTourWrapper(tour, householdDayWrapper, new TestPersisterWithHdf5());
		...
		public void TestFullHalfTourExport()
		{
			...
			PartialHalfTourWrapper wrapper = new PartialHalfTourWrapper(tour, householdDayWrapper, persister);
