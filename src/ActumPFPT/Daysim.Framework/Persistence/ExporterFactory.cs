...
namespace Daysim.Framework.Persistence {
	public sealed class ExporterFactory {
		...
		public ExporterFactory() {
			...
			_assemblyName = new AssemblyName("Daysim.Dynamic.Exporter");
		...
		public Exporter<TModel> GetExporter<TModel>(string outputPath, char delimiter) where TModel : IModel, new() {
			...
			return (Exporter<TModel>) instance;
		}
