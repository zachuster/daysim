...
namespace Daysim.Framework.Core {
	public sealed class Configuration {
		...
		[XmlAttribute]
		public double LengthUnitsPerFoot { get; set; }
	
		[XmlAttribute]
		public double DistanceUnitsPerMile { get; set; }
	
		[XmlAttribute]
		public double MonetaryUnitsPerDollar { get; set; }
        ...
        [XmlAttribute]
        public string TripModeTimeModelCoefficients { get; set; }

        [XmlAttribute]
        public bool ShouldRunTripModeTimeModel { get; set; }



		[XmlAttribute]
		public bool UseJointTours { get; set; }
