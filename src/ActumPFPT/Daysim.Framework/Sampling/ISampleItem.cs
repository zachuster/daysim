...
namespace Daysim.Framework.Sampling {
	public interface ISampleItem {
		...
		void SetAlternative<TSample>(DestinationSampler destinationSampler, Dictionary<TSample, int> sample, bool isChosenAlternative, AlternativeType alternativeType = AlternativeType.Default) where TSample : ISampleItem;
	}
